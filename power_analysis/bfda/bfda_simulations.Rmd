...
num_simulations <- 1000 # should ideally be 1000, but simulation crashed when trying values >10 
...
bfda_simulated_data_parallel_1000 <- future_map_dfr(1:nrow(informed_parameters), function(row) {
...
write.csv(bfda_simulated_data_parallel_1000, "bfa_simulated_data_1000_parallelised.csv", row.names = FALSE)
