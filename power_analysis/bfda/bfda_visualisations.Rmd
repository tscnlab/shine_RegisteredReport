...
```{r}
e2p4_slopes <- ggplot(simulations_paralleled_100, aes(x = e2_slope_mean, y = p4_slope_mean)) +
...
ggsave(filename = "heatmpap_faceted.png",
       plot = e2p4_slopes,
       width = 8, 
       height = 8,
       dpi = 600, 
...
## Heatmap 2: E2 slope and P4 slope, with "collapsed" intercept
Since we observed that the intercept values do not make a big difference, we can now 
```{r}
