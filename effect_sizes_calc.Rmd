...
parry_008 <- data.frame(reference = "Parry et al. (2010)\U00B3",
       doi = "10.3109/07420528.2010.503331",
...
parry_009 <- data.frame(
  reference = "Parry et al. (2010)\U00B3",
  doi = "10.3109/07420528.2010.503331",
...
grant_001 <- data.frame(
  reference = "Grant et al. (2024)\U00B3",
...
fazlali_001 <- data.frame(
  reference = "Fazlali et al. (2024, pre-print)\U00B3",
...
effsizes_table_1 <- effsizes_df1_combined %>%
  ...
  gt::tab_footnote(
    footnote = gt::md("\U00B3 95 % confidence intervals not available")
  ) %>%
  gt::tab_options(
...
## Add a blank col
effsizes_sex$` ` <- paste(rep(" ", 13), collapse = "     ")
...
effsizes_sex <- effsizes_sex %>%
  ...
  rename("Reference" = reference,
         "Calculated effect size" = effsize_calculated)

# Define theme
tm <- forest_theme(base_size = 10,
                   refline_gp = gpar(col ="darkred", lty = "dashed"),
                   arrow_type = "closed",
                   footnote_gp = gpar(cex = .8),
                   title_gp = gpar(cex = 1),
                   title_just = "left")
...
p1 <- forestploter::forest(effsizes_sex[,c(1,5,9)],
            ...
            theme = tm_1,
            xlim = c(-2.50,2.5),
            footnote = "\U00B3 95% confidence intervals not available",
            title = "Calculated effect sizes for studies on sex differences \nin non-visual responses to light exposure"
          )
p1
...
## Add a blank col
effsizes_horm$` ` <- paste(rep(" ", 13), collapse = "     ")
...
p2 <- forestploter::forest(effsizes_horm[,c(1,5,9)],
            ...
            xlim = c(-2.50,2.5),
            footnote = "\U00B3 95 % confidence intervals not available",
            title = "Calculated effect sizes for studies on menstrual phase related differences \nin non-visual responses to light exposure"
          )
p2
