...
vidafar_001 <- vidafar_001 %>%
  mutate(reference = "Vidafar et al. (2024)",
         ...
         outcome_measured = "Melatonin concentration in women and men under 400 lux condition",
...
vidafar_002 <- vidafar_002 %>%
   mutate(reference = "Vidafar et al. (2024)",
         ...
         outcome_measured = "Melatonin concentration in women and men under 2000 lux condition",
...
mont_fig02_men <- read.csv("Z:/shine/preregistration/power_analysis/monteleone_001_men.csv",
                           sep = ";")
  
# Importing extracted data for Figure 2 bottom panel (women)
mont_fig02_women <- read.csv("Z:/shine/preregistration/power_analysis/monteleone_001_women.csv",
                           sep = ";")
...
boyce_kennaway_002 <- boyce_kennaway_002 %>%
   mutate(reference = "Boyce & Kennaway (1987)",
         ...
         outcome_measured = "Melatonin concentration in females and meales under 1000 lux condition",
...
nathan_001 <- nathan_001 %>%
  mutate(reference = "Nathan et al. (1997)",
         ...
         outcome_measured = "Effect of gender on melatonin suppression in 200 lux condition",
...
nathan_007 <- nathan_007 %>%
  mutate(reference = "Nathan et al. (1999)",
         ...
         outcome_measured = "Effect of menstrual cycle phase (luteal, follicular, mestrual) on melatonin concentration under 200 lux",
...
nathan_008 <- nathan_008 %>%
  mutate(reference = "Nathan et al. (1999)",
         ...
         outcome_measured = "Effect of menstrual cycle (luteal, follicular, menstrual) on melatonin suppression under 200 lux",
...
parry_002 <- parry_002 %>%
  mutate(reference = "Parry et al. (1997)",
       ...
       outcome_measured = "Change score in melatonin offset time between night 1 and night 3 of circadian phase shift study",
       effsize_calculated = "d=-0.13, 95% CI [-1.01,0.76]")
...
parry_003 <- parry_003 %>%
  mutate(reference = "Parry et al. (1997)",
       ...
       outcome_measured = "Change score in melatonin onset time between night 1 and night 3 of circadian phase shift study",
...
parry_004 <- parry_004 %>%
  mutate(reference = "Parry et al. (1997)",
       ...
       outcome_measured = "Change score in melatonin duration between night 1 and night 3 of circadian phase shift study",
...
parry_005 <- parry_005 %>%
  mutate(reference = "Parry et al. (1997)",
       ...
       outcome_measured = "Change score in melatonin peak between night 1 and night 3 of circadian phase shift study",
...
parry_006 <- parry_006 %>%
  mutate(reference = "Parry et al. (1997)",
       ...
       outcome_measured = "Change score in melatonin AUC between night 1 and night 3 of circadian phase shift study",
...
parry_008 <- data.frame(reference = "Parry et al. (2010)",
    ...
    effsize_calculated = base::round(r,2)) #round the effsize to 2 digits
```
...
parry_009 <- data.frame(
  ...
  effsize_calculated = base::round(es_parry_009,2)) #round the effsize to 2 digits
```
...
parry_010 <- data.frame(
  ...
  effsize_calculated = base::round(es_parry_010,2)) #round the effsize to 2 digits
```
...
parry_010 <- data.frame(
  ...
  effsize_calculated = base::round(es_parry_011,2)) #round the effsize to 2 digits
```
